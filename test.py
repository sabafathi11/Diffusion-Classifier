...
class TemplateConfig:
    ...
    max_length: int = 5  # Max sequence length for CLIP
...
model = TemplateLearner(TemplateConfig(), class_names=["cat", "dog", "car", "tree"])
x = model.template_encoder(class_names=["cat", "dog", "car", "tree"])
print(x.shape)  # Should print shape of combined embeddings